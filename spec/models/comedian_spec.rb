RSpec.describe Comedian do
  ...
  describe 'Class Methods' do
    describe 'Statistics' do
      before(:each) do
        @city1 = "NYC"; @city2 = "JC"
        @comic1 = Comedian.create(name: 'One',   age: 34, city:@city1)
        @comic2 = Comedian.create(name: 'Two',   age: 34, city:@city2)
        @comic3 = Comedian.create(name: 'Three', age: 20, city:@city2)
        @comic4 = Comedian.create(name: 'Four',  age: 20, city:@city2)

        @special1 = Special.create(title: "something",       runtime:10, image: "path1")
        @special2 = Special.create(title: "something else",  runtime:20, image: "path2")
        @special3 = Special.create(title: "some thing",      runtime:30, image: "path3")
        @special4 = Special.create(title: "some thing else", runtime:40, image: "path4")
